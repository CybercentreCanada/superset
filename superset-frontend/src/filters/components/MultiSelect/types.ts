...
export interface PluginFilterMultiSelectCustomizeProps {
...
export type PluginFilterSelectQueryFormData = QueryFormData &
  ...
  PluginFilterMultiSelectCustomizeProps;
...
export const DEFAULT_FORM_DATA: PluginFilterMultiSelectCustomizeProps = {
  defaultValue: null,
