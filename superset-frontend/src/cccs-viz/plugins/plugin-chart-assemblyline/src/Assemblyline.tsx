...
import { AssemblylineProps, AssemblylineStylesProps } from './types';
...
const Styles = styled.div<AssemblylineStylesProps>`
...
export default class Assemblyline extends PureComponent<AssemblylineProps> {
  ...
  render() {
    ...
    const { ip, height, width } = this.props;
