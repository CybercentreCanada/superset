...
class AssemblylineChartPlugin extends _core.ChartPlugin {
  /**
  ...
  constructor() {
    const metadata = new _core.ChartMetadata({
      description: 'Assemblyline',
      name: (0, _core.t)('Assemblyline'),
      thumbnail: _thumbnail.default
    });
    super({
      buildQuery: _buildQuery.default,
      controlPanel: _controlPanel.default,
      loadChart: () => Promise.resolve().then(() => _interopRequireWildcard(require('../Assemblyline'))),
      metadata,
...
exports.default = AssemblylineChartPlugin;