...
import { DataGridProps, DataGridStylesProps } from './types';
...
const Styles = styled.div<DataGridStylesProps>`
...
export default class DataGrid extends PureComponent<DataGridProps> {
