...
import { EchartsHeatmapChartProps, EchartsHeatmapFormData } from './types';

export default class EchartsHeatmapPlugin extends ChartPlugin<
...
> {
  constructor() {
    super({
      buildQuery,
      controlPanel,
      loadChart: () => import('./EchartsHeatmap'),
